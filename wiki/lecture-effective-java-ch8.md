...
8장의 아이템은 메서드의 입구·몸통·출구 세 단계로 묶입니다.

| 단계 | 해당 아이템 |
|------|------------|
| 입구: 받는 것 | 아이템 49 매개변수 검증<br>아이템 50 방어적 복사 ⭐ |
| 몸통: 시그니처 | 아이템 51 시그니처 설계<br>아이템 52 다중정의 신중<br>아이템 53 가변인수 신중 |
| 출구: 주는 것 | 아이템 54 빈 컬렉션/배열<br>아이템 55 Optional 신중<br>아이템 56 Javadoc 작성 |
