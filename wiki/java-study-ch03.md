...
- 컬렉션 선택을 습관이 아니라 조회/삽입/삭제 패턴으로 설명할 수 있는가
- 스트림을 쓸 때 중간 연산과 최종 연산을 구분하는가
- 람다를 짧게 쓰는 것보다, 부작용이 적고 읽기 좋은지 먼저 보는가
...
이 문서의 목적은 람다와 스트림을 많이 쓰는 것이 아니라, 언제 읽기 좋아지고 언제 복잡해지는지 직접 구분해 보는 것입니다.
