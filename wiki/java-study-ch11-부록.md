...
### 포함된 자료
- [11.2 컴퓨팅 구조](https://www.notion.so/12a1e21f383681bca2eff6457ab92996)
- [11.3 네트워크 구조](https://www.notion.so/12a1e21f38368103b171fecc01f852d8)
- [11.4 개발자 기본 지식](https://www.notion.so/12a1e21f383681e38745c8328cc08c30)
- [11.13 기술면접 예상질문](https://www.notion.so/12a1e21f383681aa93a5c2275c795d33)
- [11.14 Java 면접 질문](https://www.notion.so/1381e21f383680578bf0e79abc6d601d)
- [11.16 스레드와 동기화 기초](https://www.notion.so/1561e21f3836805a9800e72f36553978)
- [11.15 Git 기초](https://www.notion.so/12a1e21f383681ae9f02c1f62fbef72d)
- [11.18 GitHub 작업 순서 가이드](https://www.notion.so/2441e21f38368079b6a3cf327ca401f7)
- [11.21 JSP 기본 개념](https://www.notion.so/1e01e21f38368054806cd77553d57318)
- [11.11 DBMS와 RDBMS 개요](https://www.notion.so/31e1e21f383681eaaa8cc2fc8c08ff6b)
- [11.12 트랜잭션과 시스템 카탈로그 개요](https://www.notion.so/31e1e21f38368134abaed6b6bb88e945)
- [11.17 포트폴리오 예제](https://www.notion.so/13f1e21f383680a58e3ac4d647e5789b)
- [11.21 Swagger 설정 가이드](https://www.notion.so/2e31e21f3836805caf85f779674c171b)
...
### 유지본 연결
- JVM 관점으로 이어서 읽기: [JVM 기초 가이드 1: 개념과 구성 원리](https://www.notion.so/28a1e21f383680ecaf29d273b8b4092d)
- 메모리 문제로 이어서 읽기: [JVM 기초 가이드 2: 메모리 관리](https://www.notion.so/28a1e21f383680a48861c8adab56bca0)
- 튜닝 관점으로 이어서 읽기: [JVM 기초 가이드 3: 튜닝과 실전 활용](https://www.notion.so/28a1e21f383680ba8748c1a88ac4a7b1)
...
### 유지본 연결
- 소켓 프로그래밍: [네트워크 프로그래밍 기초](https://www.notion.so/16d1e21f38368054ba8efd83780a626c)
- 서버와 실행 환경: [Tomcat 실행과 설정](https://www.notion.so/1d91e21f38368002a4fcc19012d5e944)
- 인증 흐름: [Spring Security 인증 흐름](https://www.notion.so/31e1e21f3836818faab6f24b66414e1c)
- 토큰 기반 인증: [토큰 기반 인증](https://www.notion.so/2ff1e21f383680bdb39ed0b873d80ed6)
...
### 유지본 문서 지도
- 컴퓨터 구조와 메모리: [11.2 컴퓨팅 구조](https://www.notion.so/12a1e21f383681bca2eff6457ab92996), [9.0 JVM 기초 가이드 1: 개념과 구성 원리](https://www.notion.so/28a1e21f383680ecaf29d273b8b4092d), [9.1 JVM 기초 가이드 2: 메모리 관리](https://www.notion.so/28a1e21f383680a48861c8adab56bca0)
- 네트워크: [11.3 네트워크 구조](https://www.notion.so/12a1e21f38368103b171fecc01f852d8), [10.5 네트워크 프로그래밍 기초](https://www.notion.so/16d1e21f38368054ba8efd83780a626c)
- 데이터베이스: [6.0 데이터베이스 설계](https://www.notion.so/12c1e21f38368088a1e6f6ab40651fb5), [10.6 JDBC 기초](https://www.notion.so/1a21e21f3836807db1afc29bc3d9b91c), [6.3 쿼리 최적화](https://www.notion.so/1d21e21f3836800f9bd3d8b0d639e881)
- 자료구조와 컬렉션: [3.2 컬렉션 프레임워크와 제네릭](https://www.notion.so/31d1e21f383681f78adec1f74bbd6ca2), [3.1 컬렉션 자료구조 활용 사례](https://www.notion.so/13f1e21f383680ae951efcaa91c07394)
...
- 면접형 복습이 필요하면 [기술면접 예상질문](https://www.notion.so/12a1e21f383681aa93a5c2275c795d33)으로 이어갑니다.
...
### 개요
이 문서는 파일 처리 실습을 하나의 과제 흐름으로 묶어 둔 유지본입니다. 중복되던 `파일처리 오프라인 게임 토이 프로젝트` 초안은 이 문서로 통합했고, 서버 동기화가 섞인 확장 버전은 [온라인 게임 토이 프로젝트](https://www.notion.so/16c1e21f383680039e78de2f000def78)로 분리했습니다.
...
- 그 확장 버전은 [온라인 게임 토이 프로젝트](https://www.notion.so/16c1e21f383680039e78de2f000def78)에서 따로 봅니다.
...
### 개요
이 문서는 책 본문을 읽다가 `DBMS`, `RDBMS`, `NoSQL` 같은 용어가 헷갈릴 때 빠르게 다시 보기 위한 참고 문서입니다. 본문 중심 설명은 [데이터베이스 설계](https://www.notion.so/12c1e21f38368088a1e6f6ab40651fb5)에 두고, 이 문서는 개념 구분만 간결하게 정리합니다.
...
### 함께 보면 좋은 문서
- [데이터베이스 설계](https://www.notion.so/12c1e21f38368088a1e6f6ab40651fb5)
- [SQL 기본기: DDL, DML, JOIN, 집계](https://www.notion.so/31e1e21f383681079f6cef5ce73220be)
- [JDBC 기초](https://www.notion.so/1a21e21f3836807db1afc29bc3d9b91c)
...
### 함께 보면 좋은 문서
- [DBMS와 RDBMS 개요](https://www.notion.so/31e1e21f383681eaaa8cc2fc8c08ff6b)
- [데이터베이스 설계](https://www.notion.so/12c1e21f38368088a1e6f6ab40651fb5)
- [SQL 기본기: DDL, DML, JOIN, 집계](https://www.notion.so/31e1e21f383681079f6cef5ce73220be)
- [JDBC 기초](https://www.notion.so/1a21e21f3836807db1afc29bc3d9b91c)
...
길게 다시 읽고 싶을 때는 [개발자 기본 지식](https://www.notion.so/12a1e21f383681e38745c8328cc08c30)을, 빠르게 확인할 때는 이 문서를 사용합니다.
...
### 연결 문서
- 컴퓨터 구조: [컴퓨팅 구조](https://www.notion.so/12a1e21f383681bca2eff6457ab92996)
- 네트워크: [네트워크 구조](https://www.notion.so/12a1e21f38368103b171fecc01f852d8)
- 데이터베이스: [데이터베이스 설계](https://www.notion.so/12c1e21f38368088a1e6f6ab40651fb5)
...
### 연결 문서
- 객체지향: [객체지향 프로그래밍](https://www.notion.so/12f1e21f383680e08f60d37f360b9062)
- 설계 원칙: [객체지향 원칙별 샘플 코드](https://www.notion.so/1301e21f38368026a616cafa13f305bc)
- 예외: [예외와 사용자 정의 예외](https://www.notion.so/1561e21f3836806b927ed4a4e1439789)
- JVM: [JVM 기초 가이드 1: 개념과 구성 원리](https://www.notion.so/28a1e21f383680ecaf29d273b8b4092d)
...
### 연결 문서
- 미니프로젝트 정리: [11.10 미니프로젝트 과제 정리](https://www.notion.so/1da1e21f38368033bd8ffc095d9bbef3)
...
### 함께 보면 좋은 문서
- [토이프로젝트 메모 앱 만들기 풀이](https://www.notion.so/14d1e21f38368040b732fba43d8ac2a2)
- [미니프로젝트 과제 정리](https://www.notion.so/1da1e21f38368033bd8ffc095d9bbef3)
- **힌트 (어려울 때만 보세요)**
