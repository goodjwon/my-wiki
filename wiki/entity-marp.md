...
마크다운으로 슬라이드 덱을 만드는 오픈소스 생태계입니다 (MIT 라이선스). 내용 작성에 집중하고 포맷팅은 Markdown + CSS 테마로 위임합니다.
...
HTML, **PDF**, **PPTX**, PNG/JPEG 이미지를 지원합니다. PDF/PPTX 렌더링에는 Chrome/Chromium을 사용합니다.
