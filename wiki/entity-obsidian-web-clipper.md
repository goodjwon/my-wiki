...
웹 페이지를 마크다운으로 변환하여 [[entity-obsidian|Obsidian]] vault에 한 번의 클릭으로 저장하는 **공식 브라우저 확장입니다**.
...
- **클립 본문**: Markdown 파일 (vault 내 지정 디렉터리)
- **하이라이트·설정**: JSON 익스포트 가능

## LLM Wiki에서의 역할

[[src-llm-wiki-pattern|LLM Wiki 패턴]]에서 `raw/`에 소스를 빠르게 추가하는 **주요 입력 채널입니다**. 워크플로는 다음과 같습니다:
