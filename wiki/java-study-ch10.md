---
title: "Java 스터디 — 10. 입출력과 네트워크"
type: source
tags: [java, study, notion, ch10]
sources: [java-study/java-study-ch10-입출력과네트워크.md]
created: 2026-04-18
updated: 2026-06-29
---
...
**트랙**: [[guide-java-track3-io-network]] · **다음 장**: [[java-study-ch11]]
...
### 개요
이 문서는 `파일 읽기와 쓰기 기초`와 [파일 처리 설계 실습](https://www.notion.so/1811e21f383680aca982d63337baae3c)를 읽은 뒤 이어서 푸는 실전문제입니다.
...
1. **문제 이름:** `대용량 CSV 집계`
  - **관련 문서:** [파일처리 실전연습문제-1](https://www.notion.so/1821e21f383680eab01ee8c4840132f6)
