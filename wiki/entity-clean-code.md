...
Robert C. Martin(Uncle Bob)이 정리한 **코드를 "깨끗하게" 만드는 미시 규칙 모음**입니다. 이름·함수·주석·형식·오류 처리부터 동시성까지 — **줄 단위·메서드 단위의 가독성 카탈로그**입니다.
...
책의 마지막 장이자 카탈로그입니다. **C·E·F·G·J·N·T 7개 카테고리, 66개 항목.**
...
- **아키텍처는 거의 다루지 않습니다** — 후속작 *Clean Architecture* 영역
- **17장 휴리스틱은 외울 게 아닙니다** — 펼쳐서 검색하는 사전
