...
초중급 개발자를 대상으로 Java 기초부터 Spring Boot 실무까지 체계적으로 구성된 Java 학습 교재. 총 **97개 문서(12개 챕터)**로 이루어져 있으며, 이론·가이드·실습·문제·풀이가 균형 있게 배치되어 있다. 구독자 학습 흐름(기초→응용→🛠미니프로젝트→정리)에 맞춘 [[guide-java-learning-path]] 5개 트랙으로 재구성돼 있다.

## 챕터 구성

| 챕터 | 주제 | 핵심 내용 |
|------|------|----------|
| 0. 안내 | 읽는 순서·문서 포맷 | 학습 로드맵 |
| 1. 환경과 실행 | Java 개발 환경 | JDK/JRE 구분, IDE 선택, Hello World, 첫 프로젝트(Maven·Gradle) |
| 2. Java 문법과 객체 | [[concept-oop]] | 변수·연산자, 제어문, 메서드·배열, 객체지향 4원칙 |
| 3. 컬렉션과 함수형 | 컬렉션·람다·스트림 | 컬렉션 프레임워크, 제네릭, 람다, 스트림, 알고리즘 기초 |
...
| 7. 서버와 인증 | Spring Security | Tomcat, Spring Security, 토큰 기반 인증 |
| 8. 테스트와 품질 | 테스트 전략 | 테스트 피라미드, JUnit 5, curl 검증 |
...
> **챕터 본문**(전문)이 위키에 게시됨 — 메뉴 `Java·Spring → Java 스터디 — 챕터 본문`, 또는 직접: [[java-study-ch00]] · [[java-study-ch01]] · [[java-study-ch02]] · [[java-study-ch03]] · [[java-study-ch04]] · [[java-study-ch06]] · [[java-study-ch07]] · [[java-study-ch08]] · [[java-study-ch09]] · [[java-study-ch10]] · [[java-study-ch05]] · [[java-study-ch11]]. 학습 흐름으로 읽으려면 [[guide-java-learning-path]].
...
- **직접 만드는 실습 프로젝트 기준**: 1장에서 만드는 Java 프로젝트와 6장에서 만드는 Spring `demo`를 기준으로 교재와 코드를 연결하여 학습
