...
Kent Beck 이 정리한 **TDD 의 원전**입니다. 화폐(돈) 예제로 1·2·3·R·G·R 사이클을 직접 보여주고, xUnit 자체를 TDD 로 만들고, 마지막에 패턴 카탈로그로 마무리합니다.
...
TDD 의 **빨강(실패하는 테스트)** = 사이클 안에 들어가 있는 **거부 신호**입니다. 위키의 다른 영역에 같은 패턴이 누적되어 있습니다.
