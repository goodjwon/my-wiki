...
이 트랙은 [[src-java-study-2024-2025]] 10장 재구성. **실제 학습·실습은 챕터 레슨에서 따라 한다** → [[java-study-ch10-입출력과네트워크]].
...
```
실습 본문·풀이 → [[java-study-ch10-입출력과네트워크]](10.8·10.9) · [[java-study-ch11-부록]](11.9).
