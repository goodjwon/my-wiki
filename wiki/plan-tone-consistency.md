...
- [ ] **Phase 3 배치 1** — 프롬프트 B: ch01 / ch05 / ch06
- [ ] **Phase 3 배치 2** — 프롬프트 B: ch07 / ch08 / ch09
- [ ] **Phase 4** — 프롬프트 C 검수 → REJECT 시 해당 파일 B 재실행
- [ ] **마감** — 배포(`/deploy`), backlog·log 기록, ch07 원노트 파편 처리 사용자 결정
