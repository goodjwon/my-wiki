...
### 2026-07-04
- ✅ **java-study 12챕터 §7-8 전수 점검** — 보강 약 120곳(용어 첫 등장 정의·예제 의도 리드인·hello-java/demo 재소개·댕글링 참조 정리) + **붙은 리스트 렌더 버그 89건 일괄 수정**(실증: 문단·펜스·표 직후 리스트는 한 줄로 붙음, 헤딩 직후만 정상 — 자동 스크립트) + ch00 daybyspring 잔재 demo 정합. **잔여 발견**: ch01 [참고 1] 2.1 빈 절, ch11 11.90 시나리오 잘림·11.23 펜스 깨짐·`‣` 잔재 → 별도 보강 후보.
