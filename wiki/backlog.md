...
### 2026-07-04
- ✅ **원본 블록 수 전수 대조 (97개 문서)** — Notion 재수집으로 블록 수·꼬리·커버리지 3단 감사. 실누락 17건을 8개 챕터에 병합(최대: ch10 §8~11 통째, ch11 11.23 §11~17, ch05 5.8 원문 전체). **원본 불신 검증 정책 신설**(CLAUDE.md 보강 정책 6): 공식 문서·소스코드 대조로 원본 오류 교정(ch01 C/C++ 표, ch06 Boot 3.x 로그 문구, ch10 JVM 옵션 등) + URL 17건 실접속 확인. 보류: ch03 3.9 링크 4건(원본 URL 유실).
