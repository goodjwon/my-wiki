---
title: "오브젝트 실전 강의 — 14장"
type: source
tags: [book, object, cho-young-ho, lecture]
sources: [object/오브젝트 실전 강의 교재 14장.md]
created: 2026-06-21
updated: 2026-07-05
---
...
첫 구현에서 정형화까지 순서대로 진행하는 단계:

1. **첫 구현** — 고정요금 정책, 한 클래스
2. **반복 발견** — 시간대별·요일별·구간별 정책, 비슷한 구조 4개
3. **정형화** — 같은 협력 패턴, 추상 + 다형성 → 15장 디자인 패턴
